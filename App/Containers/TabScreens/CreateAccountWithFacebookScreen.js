...
class LoginScreen extends Component {
  ...
  CreateAccount = () => {
    const CreateAccountWithOnlyUsernameScreen = NavigationActions.navigate({
      routeName: "CreateAccountWithOnlyUsernameScreen",
      params: {}
    });
    this.props.navigation.dispatch(CreateAccountWithOnlyUsernameScreen);
  }
      ...
      <Container>
        <View style={styles.contentStyle}>
          ...
          <Form>
            ...
            <Item regular style={styles.inputContainer1}>
